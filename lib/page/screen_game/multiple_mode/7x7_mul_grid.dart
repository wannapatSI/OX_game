...
class multiple_7x7 extends StatefulWidget {
  static String routeName = '/multiple7x7';
  const multiple_7x7({super.key});

  @override
  State<multiple_7x7> createState() => _multiple_7x7State();
}

class _multiple_7x7State extends State<multiple_7x7> {
    ...
    return InkWell(
        onTap: () {
          setState(() {
            ...
            if (check_winner_7x7(displayXO) == true) {
              gameEnd = true;
              String winner;
