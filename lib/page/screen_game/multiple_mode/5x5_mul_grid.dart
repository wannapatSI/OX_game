...
class multiple_5x5 extends StatefulWidget {
  static String routeName = '/multiple5x5';
  const multiple_5x5({super.key});

  @override
  State<multiple_5x5> createState() => _multiple_5x5State();
}

class _multiple_5x5State extends State<multiple_5x5> {
    ...
    return InkWell(
        onTap: () {
          setState(() {
            ...
            if (check_winner_5x5(displayXO) == true) {
              gameEnd = true;
              String winner;
